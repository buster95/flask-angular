...
ANGULAR_PROJECT_PATH = os.path.join(CURRENT_DIRECTORY, "ClientApp")

# os.system('cd ' + ANGULAR_PROJECT_PATH +
#           ' && ng build --watch --base-href /static/')

# os.spawnl(os.P_NOWAIT, 'cd ' + ANGULAR_PROJECT_PATH +
#           ' && ng build --watch --base-href /static/')

# subprocess.call(('cd ' + ANGULAR_PROJECT_PATH +
#                  ' && ng build --watch --base-href /static/ &'), shell=True)

subprocess.Popen(('cd ' + ANGULAR_PROJECT_PATH +
                  ' && ng build --watch &'), shell=True)
